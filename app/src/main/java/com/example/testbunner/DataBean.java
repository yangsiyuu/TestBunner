...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.img, "超级卖梦人", 3));
        list.add(new DataBean(R.drawable.img, "夏季新搭配", 1));
        list.add(new DataBean(R.drawable.img, "绝美风格搭配", 1));
        list.add(new DataBean(R.drawable.img, "微微一笑 很倾城", 3));
        return list;
    }

    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.drawable.img, "听风.赏雨", 3));
        list.add(new DataBean(R.drawable.img, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.img, "爱美.人间有之", 3));
        list.add(new DataBean(R.drawable.img, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.img, "生活的态度", 3));
        return list;
    }
    ...
    public static List<DataBean> getTestDataVideo() {
        ...
        list.add(new DataBean(R.drawable.img, "听风.赏雨", 1));
        list.add(new DataBean(R.drawable.img, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.img, "爱美.人间有之", 1));
        list.add(new DataBean(R.drawable.img, "洋洋洋.气质篇", 1));
